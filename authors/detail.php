...
<html lang="en">
    ...
    <div class="container">
        <div id="space" class="card mb-3 bg-dark text-light">
            <div class="container">
                    <h3><?php echo $authorCSV[0]  . ' ' . $authorCSV[1] ?></h3>
                <form method="post" action="/authors/delete.php">
                    <div class="form-group">
                        <input type="hidden" name="author" value="<?=$author?>" />
                        <input type="hidden" name="quote" value="<?=$quoteCSV[$quote]?>" />
                        <input type="submit" name="submit" class="btn btn-primary" value="Delete Author">
                    </div>
                </form>
                <form method="post" action="/authors/modify.php">
                    <div class="form-group">
                        <input type="hidden" name="author" value="<?=$author?>" />
                        <input type="hidden" name="quote" value="<?=$quoteCSV[$quote]?>" />
